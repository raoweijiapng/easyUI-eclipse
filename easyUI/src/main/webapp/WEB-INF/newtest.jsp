...
<body class="easyui-layout weizhi" style="width:100%;height:100%;left:0px;top:0px;">
	...
	<div data-options="region:'west',collapsible:true" title="层级" style="width:400px;">
		...
		<div class="easyui-tabs" data-options="tools:'#tab-tools',border:false,tabWidth:70,fit:true" style="width:100%;height:100%;">
			
			<div title="设备层级">
				
				<table class="easyui-treegrid" data-options="url: '',border:false,method: 'get',idField: 'id',treeField: 'name',toolbar: '#tb',fit:true">
					
					<thead>
						<tr>
							<th data-options="field:'address'" width="200px">地址</th>
							<th data-options="field:'number'" width="150px" align="right">设备编号</th>
						</tr>
					</thead>
					...
					<div data-options="region:'west',border:false,collapsible:false,split:true" style="width:50%;">
						...
						<div class="easyui-layout" data-options="fit:true">
							...
							<div data-options="region:'west',split:true" title="口径" style="width:50%;height:50%;">
								...
								<table id="opt-metersize" class="easyui-datagrid" data-options="border:false,fit:true,rownumbers:true,singleSelect:true,url:'',method:'get',toolbar:'#tb1'">
									<thead>
										<tr>
											<th data-options="field:'metersize'" style="width:40%;">口径</th>
											<th data-options="field:'createdate'" style="width:60%;">创建时间</th>											
										</tr>
									</thead>
								</table>	
								...
								<div id="tb1">
									...
									<a onclick="findmeterSize()" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'">查询</a>
								
									<a onclick="addmeterSize()" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'">新增</a>
								
									<a onclick="updatemeterSize()" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit'">修改</a>
							...
							<div data-options="region:'center'" title="厂家管理" >
								<table id="opt-producter" class="easyui-datagrid" data-options="border:false,fit:true,rownumbers:true,singleSelect:true,url:'',method:'get',toolbar:'#tb2'">
									<thead>
										<tr>
											<th data-options="field:'metersize'" style="width:40%;">厂家</th>
											<th data-options="field:'createdate'" style="width:60%;">创建时间</th>											
										</tr>
									</thead>
								</table>	
								...
								<div id="tb2">
									...
									<a onclick="findproducter()" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'">查询</a>
								
									<a onclick="addproducter()" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'">新增</a>
								
									<a onclick="updateproducter()" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit'">修改</a>
									
									<a onclick="deleteproducter()" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove'">删除</a>
							...
							<div data-options="region:'south',collapsible:false,split:true" style="height:50%;" title="相关信息" >
								...
								<div id="ft" style="padding:5px;">
							        <a href="#" id="btn_update_yingshou" style="width: 150px;text-align: center;position:relative;left:40%;" class="easyui-linkbutton" onclick="update_yingshou()">
						...
						<div class="easyui-layout" data-options="fit:true">
							...
							<div data-options="region:'north',split:true" title="通讯模式" style="width:50%;height:50%;">
								<table id="opt-connectmodel" class="easyui-datagrid" data-options="border:false,fit:true,rownumbers:true,singleSelect:true,url:'',method:'get',toolbar:'#tb3'">
									<thead>
										<tr>
											<th data-options="field:'metersize'" style="width:50%;">通讯模式</th>
											<th data-options="field:'createdate'" style="width:50%;">创建时间</th>											
										</tr>
									</thead>
								</table>	
								...
								<div id="tb3">
									...
									<a onclick="findconnectmodel()" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'">查询</a>
								
									<a onclick="addconnectmodel()" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'">新增</a>
								
									<a onclick="updateconnectmodel()" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit'">修改</a>
													
								</div>
							</div>
					
							<!-- 阀门类型的数据表格及工具栏操作 -->
							<div data-options="region:'center'" title="阀门类型" style="width:50%;height:50%;">
								<table id="opt-valuetype" class="easyui-datagrid" data-options="border:false,fit:true,rownumbers:true,singleSelect:true,url:'',method:'get',toolbar:'#tb4'">
									<thead>
										<tr>
											<th data-options="field:'metersize'" style="width:50%;">阀门类型</th>
											<th data-options="field:'createdate'" style="width:50%;">创建时间</th>											
										</tr>
									</thead>
								</table>	
								...
								<div id="tb4">
									...
									<a onclick="findvaluetype()" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'">查询</a>
								
									<a onclick="addvaluetype()" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'">新增</a>
								
									<a onclick="updatevaluetype()" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit'">修改</a>
	...
	<div id="open_add_meterSize-buttons">
		<a href="#" class="easyui-linkbutton" iconCls="icon-ok" onclick="add_meterSize()">提交</a>
	</div>
	...
	<div id="open_add_producter-buttons">
		<a href="#" class="easyui-linkbutton" iconCls="icon-ok" onclick="add_producter()">提交</a>
	</div>
	...
	<div id="open_add_connectmodel-buttons">
		<a href="#" class="easyui-linkbutton" iconCls="icon-ok" onclick="add_connectmodel()">提交</a>
	</div>
	...
	<div id="open_add_valuetype-buttons">
		<a href="#" class="easyui-linkbutton" iconCls="icon-ok" onclick="add_valuetype()">提交</a>
	</div>	
